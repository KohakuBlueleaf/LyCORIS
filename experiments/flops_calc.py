...
def mac_for_lin_wba(in_dim, out_dim, rank):
    return mac_matmul(in_dim, rank, out_dim) + in_dim * out_dim


def mac_for_conv_wba(in_dim, out_dim, rank):
    return mac_matmul(in_dim, rank, out_dim * 3**2) + in_dim * out_dim * 3**2
